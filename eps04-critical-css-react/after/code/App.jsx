    ...
    <header className="site-header">
      <div className="container header-inner">
        ...
        <nav className="main-navigation" aria-label="Main navigation">
          <span>EPS04</span>
          <span>{getText('React CSR + Critical CSS', 'React CSR + CSS حرج')}</span>
          <button 
      ...
      <div className="container hero-grid">
        <div className="hero-content">
          ...
          <div className="hero-meta">
            ...
            <div className="meta-item">
              <strong>React</strong>
              <span>{getText('Critical CSS', 'CSS حرج')}</span>
            </div>

            <div className="meta-divider"></div>

            <div className="meta-item">
              <strong>{getText('After', 'بعد')}</strong>
              <span>{getText('Optimized', 'محسن')}</span>
            </div>
          </div>
        </div>
        ...
        <div className="metrics-grid">
          <article className="metric-card">
            ...
            <div className="metric-status warning">
              {getText('Full CSS delayed 10s', 'CSS الكامل متأخر 10 ثواني')}
            </div>
          </article>
          ...
          <article className="metric-card">
            ...
            <div className="metric-status success">
              {getText('Critical CSS loads immediately', 'CSS الحرج يحمل فوراً')}
            </div>
          </article>
          ...
          <article className="metric-card">
            ...
            <div className="metric-status warning">
              {getText('Full CSS loads after delay', 'CSS الكامل يحمل بعد التأخير')}
            </div>
          </article>
          ...
          <article className="metric-card">
            ...
            <div className="metric-status success">
              {getText('Critical CSS prevents blocking', 'CSS الحرج يمنع التعطيل')}
            </div>
          </article>
        </div>
      </div>
