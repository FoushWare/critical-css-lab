...
export default function Home() {
  ...
  const t = {
    ...
    ar: {
      ...
      cssDelayLabel: 'تأخير CSS: لا يوجد',
      eps06: 'حلقة 06',
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-gray-50 rounded-lg p-6 text-center border border-gray-200">
                ...
                <div className="text-3xl font-bold text-green-600 mb-2">0s</div>
                <div className="text-sm text-green-600">No CSS delay</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-6 text-center border border-gray-200">
                ...
                <div className="text-sm text-green-600">{text.firstContentVisible}</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-6 text-center border border-gray-200">
                <div className="text-sm text-gray-600 mb-2">{text.largestPaint}</div>
                <div className="text-3xl font-bold text-green-600 mb-2">~0.6s</div>
                <div className="text-sm text-green-600">{text.largestContentVisible}</div>
              </div>
              <div className="bg-gray-50 rounded-lg p-6 text-center border border-gray-200">
                <div className="text-sm text-gray-600 mb-2">{text.blocking}</div>
                <div className="text-3xl font-bold text-green-600 mb-2">No</div>
                <div className="text-sm text-green-600">SSR + Optimized</div>
              </div>
            </div>
          </div>
        </section>
